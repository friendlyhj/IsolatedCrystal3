...
TreeRitual.addRecipe("vibrant_crystal", <minecraft:sapling>, <contenttweaker:vibrant_crystal>, 3000, [<contenttweaker:jade_leaf>, <contenttweaker:jade_leaf>, <contenttweaker:jade_leaf>, <contenttweaker:jade_leaf>, <botania:manaresource:3>, <minecraft:wheat>]);
TreeRitual.removeRecipe(<naturesaura:eye>);
TreeRitual.addRecipe("eye", <minecraft:sapling>, <naturesaura:eye>, 1000, [<botania:manaresource:1>, <minecraft:gold_ingot>, <naturesaura:gold_leaf>, <naturesaura:gold_leaf>]);
