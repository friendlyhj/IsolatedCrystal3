...
Mortar.addRecipe(allLevels, <minecraft:dye:15> * 3, 8, [<contenttweaker:blood_clot>, <contenttweaker:jade_leaf> * 2]);
Mortar.addRecipe(allLevels, <contenttweaker:crushed_crushed> * 2, 24, [<advancedmortars:mortar:1>]);
