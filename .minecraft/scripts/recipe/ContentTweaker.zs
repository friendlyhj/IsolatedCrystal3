...
Programmer.addRecipeWithOre("item", [card, <ore:crystalPureCertusQuartz>, <ore:ingotConductiveIron>, <ore:coreBuild>, <ore:coreDestroy>, <ore:processorLogic>], [1, 2, 4, 1, 1, 1], [<item:contenttweaker:item_module>], 400, 80, 250);
Programmer.addRecipeWithOre("liquid", [card, <ore:crystalPureCertusQuartz>, <ore:ingotEnergeticTin>, <ore:coreBuild>, <ore:coreDestroy>, <ore:processorLogic>], [1, 2, 1, 1, 1, 1], [<item:contenttweaker:liquid_module>], 400, 80, 250);
